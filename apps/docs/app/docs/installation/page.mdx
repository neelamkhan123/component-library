export const metadata = {
  title: "Installation",
  description: "Install @neelamkhan21/ui and configure Tailwind CSS v4 to scan it.",
};
...
<InstallCommand packages="@neelamkhan21/ui" />
...
```tsx
import { Button, Dialog, DialogContent, DialogTrigger } from "@neelamkhan21/ui";
